...
void onWheelTicks(const xbot_msgs::WheelTick::ConstPtr &msg) {
    ...
    double d_wheel_l = (double) (msg->wheel_ticks_rl - last_ticks.wheel_ticks_rl) * (1/300.0);
    double d_wheel_r = (double) (msg->wheel_ticks_rr - last_ticks.wheel_ticks_rr) * (1/300.0);
